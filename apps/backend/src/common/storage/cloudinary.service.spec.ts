...
describe('CloudinaryService', () => {
    ...
    describe('uploadFile', () => {
        it('should upload file and return public_id', async () => {
            ...
            const mockResult = {
                ...
                secure_url: 'https://res.cloudinary.com/test-cloud/image/upload/edupin/posts/test-image-123',
            };
        ...
        it('should reject on upload error', async () => {
            ...
            await expect(service.uploadFile(mockFile, 'posts')).rejects.toThrow(
                'Upload failed',
            );
        });
    });
    ...
    describe('deleteFile', () => {
        it('should delete file successfully', async () => {
            ...
            await expect(
                service.deleteFile('edupin/posts/test-image-123'),
            ).resolves.not.toThrow();

            expect(cloudinary.uploader.destroy).toHaveBeenCalledWith(
                'edupin/posts/test-image-123',
            );
        });
