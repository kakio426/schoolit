...
export class BoardController {
  ...
  async createComment(
    ...
    return this.boardService.createComment(postId, req.user.userId, body.content, body.parentId);
  }
  ...
  async hasUserLiked(@Request() req, @Param('postId', ParseIntPipe) postId: number) {
