...
export const SUBJECT_GROUPS = [
    ...
    },
    {
        ...
        subjects: [
            "사회(일반)", "지리", "역사", "윤리",
            "과학(일반)", "물리", "화학", "생명과학", "지구과학"
        ]
    },
    {
        name: "예체능/기타",
        subjects: ["체육", "음악", "미술", "한문", "정보/컴퓨터", "기술/가정", "제2외국어"]
    },
    {
        name: "비교과/전문 보조",
        subjects: ["상담", "보건", "영양", "사서", "특수교육"]
    },
    {
        name: "방과후/늘봄/기타",
        subjects: ["방과후 학교", "늘봄교실", "초등돌봄", "자유학기제", "진로체험", "코딩/AI"]
    }
];
...
export const MAJOR_CITIES = Object.keys(KOREA_REGIONS);
