...
export function useProfile() {
    ...
    const updateTeacherProfile = async (data: { bio?: string; subjects?: string[]; regions?: string[]; profileImage?: string; targetGrades?: string[]; transientDocuments?: any; checklist?: any }) => {
        setIsSaving(true);
        try {
